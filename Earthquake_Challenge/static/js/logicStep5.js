...
// Set the style for tectonicplate.
let myStyle = {
  color: "#00ff00",
  weight: 5
}

// Grabbing our tectonicplates GeoJSON data.
d3.json(tectonicplates).then(function(data) {
  console.log(data);

// Creating a tectonicpaltes GeoJSON layer with the retrieved data.
L.geoJson(data, {
    // We set the style for the line using our myStyle variable.
style: myStyle
  // // We create a popup for each point to display the magnitude and
